...
<div class="w-24 absolute right-16 top-0 cat -translate-y-full overflow-hidden group">
	<svg
					...
					><g id="head"
						...
						><g id="bowtie"
							><path
								id="Rectangle 18"
								fill="#CA9DF4"
								d="M93.284 145.179h3.343v5.642h-3.343z"
							/><path
								id="Rectangle 19"
								fill="url(#paint0_linear_363_47)"
								d="m96.627 145.179 2.934-1.937a12.152 12.152 0 0 1 5.006-1.891 2.518 2.518 0 0 1 2.845 2.158l.068.508a29.925 29.925 0 0 1 0 7.966l-.102.758a2.356 2.356 0 0 1-2.571 2.032 11.376 11.376 0 0 1-5.39-1.999l-2.79-1.953v-5.642Z"
							/><path
								id="Rectangle 20"
								fill="url(#paint1_linear_363_47)"
								d="m93.388 145.179-2.934-1.937a12.15 12.15 0 0 0-5.006-1.891 2.518 2.518 0 0 0-2.845 2.158l-.068.508a29.925 29.925 0 0 0 0 7.966l.102.758a2.357 2.357 0 0 0 2.571 2.032 11.374 11.374 0 0 0 5.39-1.999l2.79-1.953v-5.642Z"
							/></g
						></g
					></g
				></g
		...
		><defs
			><linearGradient
				id="paint0_linear_363_47"
				x1="96"
				x2="108"
				y1="148"
				y2="148"
				gradientUnits="userSpaceOnUse"
				><stop stop-color="#A17AF8" /><stop offset="1" stop-color="#F3A6D6" /></linearGradient
			><linearGradient
				id="paint1_linear_363_47"
				x1="94.015"
				x2="82.015"
				y1="148"
				y2="148"
