...
import { overridable, toWritableStores, omit, getTranslateY, set, reset, effect, removeUndefined, styleToString, isInput, sleep, noop, addEventListener } from "./helpers/index.js";
...
function getDistanceMoved(pointerStartY, event) {
