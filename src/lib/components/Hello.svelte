		...
		<div class="grid grid-cols-[1fr] max-w-lg w-full mx-auto">
			{#each Array(10) as _, i}
				<svg class="hello__svg row-start-1 col-start-1 stroke-violet-400" viewBox="0 0 482 167">
					...
					<path
						class="path-1"
						style="stroke-width:{1 + i * 0.5}; animation-delay:{2.2 + i * 0.01}s"
					...
					<path
						class="path-1"
						style="stroke-width:{1 + i * 0.5}; animation-delay:{2.6 + i * 0.01}s"
					...
					<path
						class="path-1"
						style="stroke-width:{1 + i * 0.5}; animation-delay:{4 + i * 0.01}s"
